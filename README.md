...
![Version](https://img.shields.io/badge/version-0.0.1.5-blue.svg)
...
Текущая версия проекта: **0.0.1.5**
...
- При использовании библиотеки в вашем приложении, вы не обязаны публиковать исходный код вашего приложения
- Изменения в самой библиотеке должны быть опубликованы под той же лицензией LGPL
